...
import talkNoJutsuImg from '../assets/event thumbnails/Website Assets/Talk-no-Jutsu_DEBATECOMPETITION_HELIX.webp';
import kaminariStrikeImg from '../assets/event thumbnails/Website Assets/KaminariStrike_Supersixes_CoordinationCommittee.webp';
import theLabyrinthImg from '../assets/event thumbnails/Website Assets/TheLabyrinth_MAZEHUNT_CIRCUITRON.webp';
...
const categories = [
  {
    ...
    events: [
      ...
      { title: 'Talk-no-Jutsu', desc: 'High-stakes intellectual warfare testing logic and verbal persuasion. Dismantle opponents through strategic cross-questioning and rebuttals. Command the floor with your "Verbal Geass" to emerge as the ultimate strategic orator of the arena.', icon: '🗣️', image: talkNoJutsuImg, prize: 'Exciting Prizes', time: '60 Minutes', venue: 'TBA', rules: ['Spot topics revealed 10 mins before start.', 'Judging based on cross-questioning/rebuttals.', 'Team size 3-5; strictly 8 teams (First-to-register).', 'Every member must contribute; silence leads to penalty.', 'Zero delay disqualification.', 'Fees: Transaction details must be maintained by P/I and Coordinators.'], coordinators: [{ 'name': 'Sumit Ghosh', 'contact': '6207036484' }, { 'name': 'Prayog Priyanshu', 'contact': '7870114888' }] },
    ],
  },
  {
    id: 'tarangini',
